...
export {baseEntity, Users, General, Catalogue, DrugFoodDescriptions, DrugFoodNames, DrugFoodInteractions, DrugDrugNames, DrugDrugInteractions, DrugDrugDescriptions};

export default [baseEntity, Users, General, Catalogue, DrugFoodDescriptions, DrugFoodNames, DrugFoodInteractions, DrugDrugNames, DrugDrugDescriptions, DrugDrugInteractions];